		...
		parts: [
			{
				...
				color: '#339167', fakeHueVal: {hue: 155, sat: 100, bri: 35},
				pointNames: ['UC Davis!','Stanford','UC Irvine','UC Berkeley'],
				pointTitles: ['COOLEST SCHOOL 2012', '3rd COOLEST', '#9 COOL SCHOOL', '20th \'COOLEST\''],
			...
			},
			{
				...
				color: '#685338', fakeHueVal: {hue: 60, sat: 76, bri: 25},
				pointNames: ['UC Davis..','Stanford','UC IRVINE','UC Berkeley'],
				pointValues: [55,6,1,33],
				pointTitles: ['2014: FELL TO 55TH', 'now 6th COOLEST', 'new #1 COOL SCHOOL', '33rd place in 2014'],
			...
			},
			{
				...
				color: '#681516', fakeHueVal: {hue: 10, sat: 96, bri: 10},
			...
			},
			{
				...
				color: '#1A1A1A',  fakeHueVal: {hue: 10, sat: 0, bri: 0},
				pointNames: ['A','B','C','D'],
